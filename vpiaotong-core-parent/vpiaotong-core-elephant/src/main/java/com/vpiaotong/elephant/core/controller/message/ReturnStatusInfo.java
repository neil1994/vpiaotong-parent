...
public final class ReturnStatusInfo {
    ...
    /** 状态码500值 */
    private static final String STATUS_600 = "600";
    
    /** 状态码500值 */
    private static final String STATUS_700 = "700";
    ...
    static {
        ...
        addStatusMessage(MessageStatus.KEY600,
        		new AbstractMap.SimpleEntry<String, String>(STATUS_KEY_CODE, STATUS_600));
        addStatusMessage(MessageStatus.KEY700,
        		new AbstractMap.SimpleEntry<String, String>(STATUS_KEY_CODE, STATUS_700));
    }
