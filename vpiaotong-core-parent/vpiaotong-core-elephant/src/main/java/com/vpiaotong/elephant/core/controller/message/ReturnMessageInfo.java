package com.vpiaotong.elephant.core.controller.message;
...
public final class ReturnMessageInfo {
    ...
    /** 图片验证码错误*/
    private static final String MESSAGE_600 = "图片验证码错误";
    
    /** 短信发送频繁 */
    private static final String MESSAGE_700 = "短信发送频繁";
    ...
    static {
        ...
        addStatusMessage(Message.KEY600, new AbstractMap.SimpleEntry<String, String>(MESSAGE_KEY_CODE, MESSAGE_600));
        addStatusMessage(Message.KEY700, new AbstractMap.SimpleEntry<String, String>(MESSAGE_KEY_CODE, MESSAGE_700));
    }
